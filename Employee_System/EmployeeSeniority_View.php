...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php 
              $sql = " SELECT a.EP_NO, b.KindName, b.EmployeeKindID, 
                       cast(a.On_Day as Date) as On_Day,
                       cast(a.Off_Day as Date) as Off_Day 
                       FROM EmployeeSeniority a 
              ...
              while($row = $search_query->fetch(PDO::FETCH_ASSOC)){
                echo "<tr>";
                echo "<td><a href='EmployeeSeniority_edit.php?EP_NO=" . $row['EP_NO'] . "&EmployeeKindID=" . $row['EmployeeKindID']  . "'>編輯</a></td>";
